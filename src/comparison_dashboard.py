...
def parse_lab_values_from_text(text: str) -> Dict[str, Dict[str, Any]]:
  ...
  for line in text.splitlines():
    ...
    for term in terms:
      ...
      unit_match = re.match(r"([A-Za-z%/^0-9.]+)", after_value)
      if unit_match:
...
def _technical_lab_points(comparisons: List[Dict[str, Any]]) -> Dict[str, List[str]]:
  ...
  for item in comparisons:
    line = (
      ...
      f"({item['direction']}, {item['difference']}, {item['percentage_change']}); "
...
def _comparison_html(result: Dict[str, Any], title: str) -> str:
  ...
  abnormal_card = section_card("Abnormal / Worsened Parameters", "", sections["abnormal_or_worse"], "attention")
  ...
  <div class="mb-reference-page">
   <div class="mb-reference-header">
    ...
    <div class="mb-ref-tip">
     ...
     <div>Youre one tap away. Open an option below and compare your health progress.</div>
    </div>
   </div>
...
6. Key Differences
List 35 specific differences between previous and current X-rays.
